...
/***/ function(module, exports, __webpack_require__) {
	...
	var _configRoutesJsx = __webpack_require__(196);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsMainJsx = __webpack_require__(197);

	var _componentsMainJsx2 = _interopRequireDefault(_componentsMainJsx);

	var _componentsAnalyticsJsx = __webpack_require__(198);

	var _componentsAnalyticsJsx2 = _interopRequireDefault(_componentsAnalyticsJsx);

	var _componentsCollectionJsx = __webpack_require__(199);

	var _componentsCollectionJsx2 = _interopRequireDefault(_componentsCollectionJsx);

	var _componentsMovieSearchJsx = __webpack_require__(200);

	var _componentsMovieSearchJsx2 = _interopRequireDefault(_componentsMovieSearchJsx);

	var routes = _react2['default'].createElement(
	  _reactRouter.Route,
	  { name: 'home', path: '/', handler: _componentsMainJsx2['default'] },
	  _react2['default'].createElement(_reactRouter.Route, { name: 'movies', path: '/movies', handler: _componentsMovieSearchJsx2['default'] }),
	  _react2['default'].createElement(_reactRouter.Route, { name: 'collection', path: '/collection', handler: _componentsCollectionJsx2['default'] }),
	  _react2['default'].createElement(_reactRouter.Route, { name: 'analytics', path: '/analytics', handler: _componentsAnalyticsJsx2['default'] })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchJsx = __webpack_require__(201);
	  ...
	  _createClass(Search, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement('input', { type: 'text', className: 'form-control', ref: 'movieTitle' }),
	        _react2['default'].createElement(
	          'button',
	          { type: 'button', className: 'btn btn-default', onclick: this._handleClick },
	          'Submit'
	        )
	      );
	    }
