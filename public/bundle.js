...
/***/ function(module, exports, __webpack_require__) {
	...
	var Analytics = __webpack_require__(198);
	var Collection = __webpack_require__(199);
	var MovieSearch = __webpack_require__(200);

	module.exports = React.createElement(
	  Route,
	  { name: 'home', path: '/', handler: Main },
	  React.createElement(Route, { name: 'movies', path: '/movies', handler: MovieSearch }),
	  React.createElement(Route, { name: 'collection', path: '/collection', handler: Collection }),
	  React.createElement(Route, { name: 'analytics', path: '/analytics', handler: Analytics })
	);
